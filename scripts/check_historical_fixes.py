...
ANCHORS = [
    ...
    ("215_llama_helper_kv_cache_q4_0",
     "llama-helper/src/main.rs",
     r"§215 cnblogs.*文章 pin Q4_0 是 4K context 的建议"),
    ...
    ("223_n_ubatch_set",
     "llama-helper/src/main.rs",
     r"§223.*N_UBATCH 跟 N_BATCH 设一样"),
    ("224_n_ubatch_512_separate_from_n_batch",
     "llama-helper/src/main.rs",
     r"const N_UBATCH: u32 = 512;"),
    ("224_logical_vs_physical_batch_comment",
     "llama-helper/src/main.rs",
     r"logical max.*physical max"),
    ("223_kv_cache_q4_0_removed",
     "llama-helper/src/main.rs",
     r"n_ctx=16K.*实测"),
    ("223_stderr_log_file_redirect",
     "frontend/src-tauri/src/summary/summary_engine/sidecar.rs",
     r"fn open_stderr_log_file"),
    ("223_app_data_dir_field",
     "frontend/src-tauri/src/summary/summary_engine/sidecar.rs",
     r"§223: app data dir for redirecting llama-helper stderr"),
    ("223_kv_cache_import_removed",
     "llama-helper/src/main.rs",
     r"use llama_cpp_2::context::params::LlamaContextParams;"),
    ...
    ("225_default_max_tokens_1200",
     "frontend/src-tauri/src/summary/summary_engine/models.rs",
     r"pub const DEFAULT_MAX_TOKENS: i32 = 1000;"),  # §226: was 1200, now 1000
    ("225_section_test_exists",
     "frontend/src-tauri/src/summary/summary_engine/client.rs",
     r"section_225_default_max_tokens_was_4096_now_1000"),
    ...
    # === §226: 豆包建议调整 — temp=0, rep=1.10, n_threads=4, overlap=150, max_tokens=1000 (2026-09-10 立) ===
    ("226_n_threads_min_4",
     "llama-helper/src/main.rs",
     r"cores\.min\(4\)\.max\(1\)"),
    ("226_default_temperature_0",
     "llama-helper/src/main.rs",
     r"LLAMA_DEFAULT_TEMPERATURE[\s\S]*\.unwrap_or\(0\.0\)"),
    ("226_default_repeat_penalty_1_10",
     "llama-helper/src/main.rs",
     r"LLAMA_DEFAULT_REPEAT_PENALTY[\s\S]*\.unwrap_or\(1\.10\)"),
    ("226_qwen25_temp_zero",
     "frontend/src-tauri/src/summary/summary_engine/models.rs",
     r"pub fn qwen25_summary[\s\S]*temperature: 0\.0"),
    ("226_qwen25_rep_1_10",
     "frontend/src-tauri/src/summary/summary_engine/models.rs",
     r"repeat_penalty: 1\.10,\s+penalty_last_n: 256"),
    ("226_default_max_tokens_1000",
     "frontend/src-tauri/src/summary/summary_engine/models.rs",
     r"pub const DEFAULT_MAX_TOKENS: i32 = 1000;"),
    ("226_section_test_exists",
     "frontend/src-tauri/src/summary/summary_engine/models.rs",
     r"section_226_qwen25_summary_sampling_params"),
